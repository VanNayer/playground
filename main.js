...
var ReplaySubject_1 = __webpack_require__(44);
exports.ReplaySubject = ReplaySubject_1.ReplaySubject;
var BehaviorSubject_1 = __webpack_require__(55);
...
// dom events
var start$ = _rxjs.Observable.fromEvent(startButton, 'click');
var stop$ = _rxjs.Observable.fromEvent(stopButton, 'click');
var reset$ = _rxjs.Observable.fromEvent(resetButton, 'click');
var half$ = _rxjs.Observable.fromEvent(halfButton, 'click');
var quarter$ = _rxjs.Observable.fromEvent(quarterButton, 'click');

// TIMER
var initialData = { count: 0 };

var reset = function reset() {
  return initialData;
};
var inc = function inc(_ref) {
  var count = _ref.count;
  return { count: count + 1 };
};

var starters$ = _rxjs.Observable.merge(start$.mapTo(1000), half$.mapTo(500), quarter$.mapTo(250)).share();

var intervalActions = function intervalActions(time) {
  return _rxjs.Observable.merge(_rxjs.Observable.interval(time).takeUntil(stop$).mapTo(inc), reset$.mapTo(reset));
};

var timer$ = starters$.switchMap(intervalActions).startWith(initialData).scan(function (acc, fun) {
  return fun(acc);
});

// INPUT
var input$ = _rxjs.Observable.fromEvent(input, 'input').map(function (event) {
  return event.target.value;
});

var gameInProgress$ = timer$.takeWhile(function (_ref2) {
  var count = _ref2.count;
  return count <= 3;
}).withLatestFrom(input$, function (_ref3, input) {
  var count = _ref3.count;
  return { count: count, text: input };
}).share();

gameInProgress$.repeat().subscribe(function () {
  return input.value = '';
});
...
gameInProgress$.filter(function (_ref4) {
  var count = _ref4.count,
      text = _ref4.text;
  return count === parseInt(text);
}).reduce(function (acc, curr) {
  return acc + 1;
}, 0).repeat().subscribe(function (x) {
  return score.innerHTML = '' + x;
}, function (err) {
  return console.log(err);
}, function () {
  return console.log('My stream is over!');
});
...
var foo = _rxjs.Observable.create(function (obs) {
  var i = 0;
...
var Observable_1 = __webpack_require__(0);
var single_1 = __webpack_require__(331);
...
var Observable_1 = __webpack_require__(0);
var skip_1 = __webpack_require__(332);
...
var Observable_1 = __webpack_require__(0);
var throttle_1 = __webpack_require__(344);
...
var Observable_1 = __webpack_require__(0);
var toArray_1 = __webpack_require__(348);
...
var Observable_1 = __webpack_require__(0);
var toPromise_1 = __webpack_require__(349);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(86), __webpack_require__(4)))
